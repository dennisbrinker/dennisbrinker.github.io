...
var snackScrolltrigger = function() {
    ...
    function createST(anim) {
        ...
        switch(anim.type) {
            ...
            case "slide-left":
                timeline
                .fromTo(anim.target, {x: anim.transform}, {duration: anim.duration, x: "0%", delay: anim.delay, ease: anim.ease});
            break;
            ...
            case "slide-down":
                timeline
                .fromTo(anim.target, {y: "-"+ anim.transform}, {duration: anim.duration, y: "0%", delay: anim.delay, ease: anim.ease});
            break;
    ...
    // failsafe relocated to showSnack()
